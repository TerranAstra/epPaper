...
document.addEventListener('DOMContentLoaded', async (event) => {
  ...
  void startMcpGoogleMapServer(transportA, async (params: { location?: string, origin?: string, destination?: string, search?: string }) => {
    await playground.renderMapQuery(params);
  });
