    ...
    <>
      <aside className={c('sidebar', { open: isSidebarOpen })}>
        ...
        <div className="sidebar-content">
          ...
          <div className="sidebar-section">
            <h4 className="sidebar-section-title">Local Files</h4>
            <p className="sidebar-hint">Sandboxed to <code>user-files/</code></p>
            <button onClick={() => setShowFiles(true)}>
              <span className="icon">folder</span> Open File Manager
            </button>
          </div>
        </div>
      </aside>
