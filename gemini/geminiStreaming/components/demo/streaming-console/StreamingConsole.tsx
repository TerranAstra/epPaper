...
import { publishTurn } from '@/lib/telemetry';
...
export default function StreamingConsole() {
  ...
  useEffect(() => {
    ...
    const handleInputTranscription = (text: string, isFinal: boolean) => {
      ...
      if (isFinal) {
        const finalText = last && last.role === 'user' && !last.isFinal ? (last.text + text) : text;
        ...
        publishTurn(finalTurn, { model, voice });
      }
    };
    ...
    const handleOutputTranscription = (text: string, isFinal: boolean) => {
      ...
      if (isFinal) {
        const finalText = last && last.role === 'agent' && !last.isFinal ? (last.text + text) : text;
        const finalTurn: ConversationTurn = {
          timestamp: new Date(),
          role: 'agent',
          text: finalText,
    ...
    const handleTurnComplete = () => {
      ...
      if (last && !last.isFinal) {
        ...
        // Fallback publish in case the final chunk did not trigger above
        const finalTurn: ConversationTurn = {
